...
{	
	...
	private void readData(Node stepnode) throws KettleXMLException
	{
		...
		{
			throw new KettleXMLException(BaseMessages.getString(PKG, "JsoupInputMeta.Exception.ErrorLoadingXML", e.toString()));
		}
	}
	...
	throws KettleException
	{
		...
		try
		{
			...
			for (int i=0;i<nrFields;i++)
			{
				...
				field.setTrimType( JsoupInputField.getTrimTypeByCode( rep.getStepAttributeString (id_step, i, "field_trim_type") ));
				field.setRepeated( rep.getStepAttributeBoolean(id_step, i, "field_repeat") );
				field.setResultType( JsoupInputField.getResultTypeByCode( rep.getStepAttributeString(id_step, i, "field_result_type")));
				inputFields[i] = field; 
			}
		...
		{
			throw new KettleException(BaseMessages.getString(PKG, "JsoupInputMeta.Exception.ErrorReadingRepository"), e);
		}
	}
	...
	throws KettleException
	{
		try
		{
			...
			for (int i=0;i<inputFields.length;i++)
			{
				...
				rep.saveStepAttribute(id_transformation, id_step, i, "field_result_type",   field.getResultTypeCode());
		...
		{
			throw new KettleException(BaseMessages.getString(PKG, "JsoupInputMeta.Exception.ErrorSavingToRepository", ""+id_step), e);
		}
	}
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, String input[], String output[], RowMetaInterface info)
	{
		...
		if(!isInFields())
		{
			...
			if (input.length<=0)
			{		
				cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.NoInputExpected"), stepMeta);
				remarks.add(cr);
			}
			else
			{
				cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.NoInput"), stepMeta);
				remarks.add(cr);
			}
		}
		...
		{
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.NoInputField"), stepMeta);
			remarks.add(cr);
		}		
		...
		if(isInFields())
		{
			 ...
			 {
				 cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.NoField"), stepMeta);
				 remarks.add(cr); 
			 }
			 else
			 {
				 cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.FieldOk"), stepMeta);
				 remarks.add(cr); 
			 }		 
		}
		else
		{
			...
			{
				cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.NoFiles"), stepMeta);
				remarks.add(cr);
			}
			else
			{
				cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG, "JsoupInputMeta.CheckResult.FilesOk", ""+fileInputList.getFiles().size()), stepMeta);
				remarks.add(cr);
			}	
		}	
	}
