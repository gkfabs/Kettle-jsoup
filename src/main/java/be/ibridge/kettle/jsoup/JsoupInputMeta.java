...
/**
 * Store run-time data on the JsoupInput step.
 */
public class JsoupInputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private JsoupInputField inputFields[];
   ...
   */
  public JsoupInputField[] getInputFields() {
    return inputFields;
  }
   ...
   */
  public void setInputFields(JsoupInputField[] inputFields) {
  ...
  public Object clone() {
    JsoupInputMeta retval = (JsoupInputMeta) super.clone();
    ...
    for (int i = 0; i < nrFields; i++) {
      if (inputFields[i] != null) {
        retval.inputFields[i] = (JsoupInputField) inputFields[i].clone();
      }
    }
    return retval;
  }
  ...
  public String getXML() {
    ...
    for (int i = 0; i < fileName.length; i++) {
      ...
      retval.append("      ").append(
          XMLHandler.addTagValue("include_subfolders", includeSubFolders[i]));
    ...
    for (int i = 0; i < inputFields.length; i++) {
      JsoupInputField field = inputFields[i];
    ...
    retval.append("    ").append(
        XMLHandler.addTagValue("rootUriNameFieldName", rootUriNameFieldName));
  ...
  private void readData(Node stepnode) throws KettleXMLException {
    try {
      ...
      IsIgnoreEmptyFile =
          "Y".equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "IsIgnoreEmptyFile"));
      ...
      for (int i = 0; i < nrFields; i++) {
        ...
        JsoupInputField field = new JsoupInputField(fnode);
        inputFields[i] = field;
      }
      ...
      throw new KettleXMLException(BaseMessages.getString(PKG,
          "JsoupInputMeta.Exception.ErrorLoadingXML", e.toString()));
    }
  }
  ...
  public void allocate(int nrfiles, int nrfields) {
    ...
    inputFields = new JsoupInputField[nrfields];
  }
  ...
  public void setDefault() {
    ...
    for (int i = 0; i < nrFields; i++) {
      inputFields[i] = new JsoupInputField("field" + (i + 1));
    }
  ...
  public void getFields(RowMetaInterface r, String name, RowMetaInterface info[],
    ...
    if (includeFilename) {
      ValueMetaInterface v =
          new ValueMeta(space.environmentSubstitute(filenameField), ValueMeta.TYPE_STRING);
      v.setLength(250);
      v.setPrecision(-1);
      v.setOrigin(name);
      r.addValueMeta(v);
    ...
    if (getPathField() != null && getPathField().length() > 0) {
      ValueMetaInterface v =
          new ValueMeta(space.environmentSubstitute(getPathField()), ValueMeta.TYPE_STRING);
      v.setLength(100, -1);
      v.setOrigin(name);
      r.addValueMeta(v);
    }
    if (getSizeField() != null && getSizeField().length() > 0) {
      ValueMetaInterface v =
          new ValueMeta(space.environmentSubstitute(getSizeField()), ValueMeta.TYPE_INTEGER);
      v.setOrigin(name);
      v.setLength(9);
      r.addValueMeta(v);
    }
    ...
    if (getLastModificationDateField() != null && getLastModificationDateField().length() > 0) {
      ValueMetaInterface v =
          new ValueMeta(space.environmentSubstitute(getLastModificationDateField()),
              ValueMeta.TYPE_DATE);
      v.setOrigin(name);
      r.addValueMeta(v);
    }
    if (getUriField() != null && getUriField().length() > 0) {
      ValueMetaInterface v =
          new ValueMeta(space.environmentSubstitute(getUriField()), ValueMeta.TYPE_STRING);
      v.setLength(100, -1);
      v.setOrigin(name);
      r.addValueMeta(v);
    }
  ...
  public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> databases,
    ...
    try {
      ...
      for (int i = 0; i < nrFields; i++) {
        ...
        field.setTrimType(JsoupInputField.getTrimTypeByCode(rep.getStepAttributeString(id_step, i,
            "field_trim_type")));
      ...
      throw new KettleException(BaseMessages.getString(PKG,
          "JsoupInputMeta.Exception.ErrorReadingRepository"), e);
    }
  }
  ...
  public void saveRep(Repository rep, ObjectId id_transformation, ObjectId id_step)
    ...
    try {
      ...
      for (int i = 0; i < inputFields.length; i++) {
        ...
        rep.saveStepAttribute(id_transformation, id_step, i, "field_currency", field
            .getCurrencySymbol());
        rep.saveStepAttribute(id_transformation, id_step, i, "field_decimal", field
            .getDecimalSymbol());
        rep.saveStepAttribute(id_transformation, id_step, i, "field_group", field.getGroupSymbol());
        rep.saveStepAttribute(id_transformation, id_step, i, "field_length", field.getLength());
        rep.saveStepAttribute(id_transformation, id_step, i, "field_precision", field
            .getPrecision());
        rep.saveStepAttribute(id_transformation, id_step, i, "field_trim_type", field
            .getTrimTypeCode());
      ...
      rep.saveStepAttribute(id_transformation, id_step, "rootUriNameFieldName",
          rootUriNameFieldName);
      rep.saveStepAttribute(id_transformation, id_step, "extensionFieldName", extensionFieldName);
    } catch (Exception e) {
      throw new KettleException(BaseMessages.getString(PKG,
          "JsoupInputMeta.Exception.ErrorSavingToRepository", "" + id_step), e);
    }
  }
  ...
  public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta,
      ...
      if (input.length <= 0) {
        cr =
            new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                "JsoupInputMeta.CheckResult.NoInputExpected"), stepMeta);
        remarks.add(cr);
      } else {
        cr =
            new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG,
                "JsoupInputMeta.CheckResult.NoInput"), stepMeta);
        remarks.add(cr);
      }
    }
    ...
    if (getInputFields().length <= 0) {
      cr =
          new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
              "JsoupInputMeta.CheckResult.NoInputField"), stepMeta);
      remarks.add(cr);
    }
    ...
    if (isInFields()) {
      if (Const.isEmpty(getFieldValue())) {
        cr =
            new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                "JsoupInputMeta.CheckResult.NoField"), stepMeta);
        remarks.add(cr);
      } else {
        cr =
            new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG,
                "JsoupInputMeta.CheckResult.FieldOk"), stepMeta);
        remarks.add(cr);
      }
    } else {
      ...
      if (fileInputList == null || fileInputList.getFiles().size() == 0) {
        cr =
            new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                "JsoupInputMeta.CheckResult.NoFiles"), stepMeta);
        remarks.add(cr);
      } else {
        cr =
            new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG,
                "JsoupInputMeta.CheckResult.FilesOk", "" + fileInputList.getFiles().size()),
                stepMeta);
        remarks.add(cr);
      }
    }
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new JsoupInput(stepMeta, stepDataInterface, cnr, tr, trans);
  }

  public StepDataInterface getStepData() {
    return new JsoupInputData();
  }
